...
import inter from './assets/fonts/Exo-SemiBold.ttf?url'
...
export function Computers(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <ScreenVideo frame="Object_209" panel="Object_210" y={5} position={[-1.43, 2.5, -1.8]} rotation={[0, 1, 0]} VideoScreenComponent={VideoScreen1} videoSrc={VIDEO_SOURCES.VIDEO1} />
      <ScreenText invert frame="Object_212" panel="Object_213" x={-5} y={5} position={[-2.73, 0.63, -0.52]} rotation={[0, 1.09, 0]} />
     
      <ScreenVideo invert frame="Object_215" panel="Object_216" position={[1.84, 0.38, -1.77]} rotation={[0, -Math.PI / 9, 0]} VideoScreenComponent={VideoScreen2} videoSrc={VIDEO_SOURCES.VIDEO2} />
...
function ScreenVideo({ frame, panel, videoSrc, invert, VideoScreenComponent, ...props }) {
  return (
    <Screen frame={frame} panel={panel} {...props}>
      <PerspectiveCamera makeDefault manual aspect={1 / 1} position={[0, 0, 15]} />
      <color attach="background" args={[invert ? 'black' : '#03d7fc']} />
...
function ScreenText({ invert, x = 0, y = 1.2, ...props }) {
  ...
  return (
    <Screen {...props}>
      ...
      <ambientLight intensity={0.5} />
      <directionalLight position={[10, 10, 5]} />
      <Text font={inter} position={[x, y-0.2, 0]} ref={textRef} fontSize={3.4} letterSpacing={-0.08} color={!invert ? 'black' : '#fc0398'}>
...
function ScreenInteractive(props) {
  return (
    <Screen {...props}>
      ...
      <GeometricShape position={[-3.15, 0.75, 0]} scale={0.5} />
    </Screen>
  )
}
