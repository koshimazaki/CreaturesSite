...
import {VideoScreen1, VideoScreen2, VideoScreen3} from './VideoScreen'
...
import videoSrc3 from '/src/assets/video/Rive_Low.mp4?url'
...
export function Computers(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <ScreenVideo invert frame="Object_212" panel="Object_213" x={-5} y={5} position={[-2.73, 0.63, -0.52]} rotation={[0, 1.09, 0]} VideoScreenComponent={VideoScreen3} videoSrc={VIDEO_SOURCES.VIDEO3}isColorSwapped={isColorSwapped} />
