...
import { PastelCreature,Palm, Plant, Gamepad, Dragon, Tripo, Moog, Speeder, VCS3, Pyramid } from './Models';
    ...
    return (
      <>
        ...
        <Suspense fallback={null}>
          ...
          <Palm position={[-2.4, -1.35, 1.38]} scale={[0.2, 0.2, 0.2]} rotation={[0, 0, 0]} />
          <Pyramid position={[-2.1, -1.25, 0.58]} scale={[0.04, 0.04, 0.04]} rotation={[0, 5.74, 0]} />
          ...
          <PastelCreature 
          position={[-0.3, -1, -.5]} scale={[0.23, 0.23, 0.23]} rotation={[0, 6.8, 0]} 
          visible={false}  // Initially hidden
          userData={{ isLoot: true }}  // Mark it as loot item
